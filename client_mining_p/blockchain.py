...
def mine():
    ...
    values = request.get_json() # receive proof
    required = ['proof']
    ...
    if blockchain.valid_proof(last_proof, submitted_proof): # validate proof
    ...
    # Forge the new BLock by adding it to the chain
        ...
        # new block to prevent other transaction
        response = {
        'message': message,
        'index': block['index'],
        ...
        message = "proof not validated or already submitted. No new block forged"
        response = {
            'message': message
        }
        return jsonify(response), 200
