...
class Blockchain(object):
    ...
    def valid_proof(last_proof, proof):
        ...
        #print(f'last {last_proof} running {proof} guess {guess_hash}')
        return guess_hash[:4] == '0000'  # 4 leading 0000 means valid hash
    ...
    def valid_chain(self, chain):
        ...
        while current_index < len(chain):
            ...
            if blockchain.hash(last_block) != block.previous_hash :
                return False
